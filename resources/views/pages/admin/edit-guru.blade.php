...
@section('content')
    <div class="flex flex-col justify-center">
        ...
        <form action="{{ route('update.guru',$guru->id) }}" @method('PUT')>
            ...
            <div class="mb-6">
                <label for="nomor_induk_pegawai" class="block mb-2 text-sm font-medium text-gray-900">Nomor Induk Pegawai</label>
                <input type="text" name="nomor_induk_pegawai" id="nomor_induk_pegawai" value="{{ $guru->nomor_induk_pegawai }}"
