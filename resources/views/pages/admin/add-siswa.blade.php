        ...
        <form action="{{ route('store.siswa') }}" method="POST">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div class="mb-6">
                    ...
                    <select id="id_kelas_now" name="id_kelas_now" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                ...
                <div>
                    <label for="nama_orang_tua" class="block mb-2 text-sm font-medium text-gray-900">Nama Orang Tua / Wali</label>
                    <input type="text" id="nama_orang_tua" name="nama_orang_tua"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                        required />
                </div>
                <div>
                    <label for="no_hp_ortu" class="block mb-2 text-sm font-medium text-gray-900">No Telepon Orang Tua / Wali</label>
