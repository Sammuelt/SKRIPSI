...
@section('content')
    <div class="flex flex-col justify-center">
        ...
        <form action="{{ route('update.siswa',$siswa->id) }}" @method('PUT')>
            ...
            <div class="mb-6">
                <label for="nisn" class="block mb-2 text-sm font-medium text-gray-900">NISN --->("anda tidak dapat mengubah")</label>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div>
                    <label for="id_kelas_now" class="block mb-2 text-sm font-medium text-gray-900">Kelas --->("anda tidak dapat mengubah")</label>              
