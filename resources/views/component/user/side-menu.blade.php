        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <ul id="dropdown-academic" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('index.input.tpcp') }}"
                            class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 hover:text-gray-900">Input TP/CP</a>
                    </li>
                    <li>
                        <a href="{{ route('index.input.akademik') }}"
                            class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 hover:text-gray-900">Input Nilai Mata Pelajaran</a>
                    </li>
                    <li>
                        <a href="{{ route('index.input.ekskul') }}"
                            class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 hover:text-gray-900">Input Nilai Ekstrakulikuler</a>
                    </li>
                    <li>
                        <a href="{{ route('input.raport.akademik') }}"
                            class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 hover:text-gray-900">Input Raport</a>
                    </li>
                </ul>
            </li>
                ...
                <ul id="dropdown-mbkm" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('index.p5') }}"
                            class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 hover:text-gray-900">Input Elemen Projek P5</a>
                    </li>
                    <li>
                        <a href="{{ route('index.input.p5') }}"
                            class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 hover:text-gray-900">Input Nilai Projek P5</a>
                    </li>
                    <li>
                        <a href="{{ route('index.input.mbkm') }}"
                            class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 hover:text-gray-900">Input Raport Merdeka Belajar</a>
                    </li>
                </ul>
            </li>
